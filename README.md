...
![architecture](https://user-images.githubusercontent.com/63587953/235871637-081819c8-3060-4c62-8b99-3e67bea9fad0.jpg)

Objectives:

1. create Monitoring Application in Python using Flask and psutil
2. run a Python App locally
3. Crating a Jenkins Pipeline
4.containerize the Python application
   i. Creat Dockerfile
  ii. Build DockerImage
